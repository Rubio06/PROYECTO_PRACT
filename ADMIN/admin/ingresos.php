    ...
    <div class="modal-content">
      <div class="modal-header" style="border-bottom: 4px solid #2e77bc; background-color: #fff; color: #111;">
        ...
        <h2 class="modal-title" id="myModalLabel" style="font-size: 9pt;">
          <h4><i class="fa fa-plus-square-o"></i>&nbsp; Nueva entrada de dinero.</h4>
        </h2>
      </div>
                    ...
                    <tr>
                      <td width="50%">
                        ...
                        <select class="form-control" name="cuenta">
                          <?php
                          while ($fila = $bd->mostrar_registros()) { ?>
                            <option value="<?php echo $id = $fila->id_accounts; ?>">
                              <p><?php echo $fila->name_bank_accounts ?> -- <?php echo $fila->tipe_accounts ?></p>
                            </option>
                          <?php
                          }
                          ?>
                      ...
                      <td width="50%">
                        <center>
                          ...
                          <select class="form-control" name="divisa">
                            <?php
                            while ($fila = $bd->mostrar_registros()) { ?>
                              <option value="<?php echo $id = $fila->id_divisas; ?>">
                                <p> <?php echo $fila->simbolo_divisa ?>&nbsp;&nbsp; <?php echo $fila->name_divisa; ?></p>
                              </option>
                            <?php
                            }
                            ?>
  ...
  <div id="login-overlay" class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header" style="border-bottom: 4px solid #2e77bc; background-color: #fff; color: #111;">
        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>
        <h2 class="modal-title" id="myModalLabel" style="font-size: 9pt;">
          <h4><i class="fa fa-plus-square-o"></i>&nbsp; Nueva Salida de dinero.</h4>
        </h2>
      </div>
      <div style="margin-top: 1px; background-color: #2e77bc; height: 1px; width: 100%;"></div>
      <div class="modal-body">
                    ...
                    <tr>
                      <td width="50%">
                        ...
                        <select class="form-control" name="saldo">
                          <?php
                          while ($fila = $bd->mostrar_registros()) { ?>
                            <option value="<?php echo $id = $fila->id_saldo; ?>">
                              <p><?php echo $fila->name_bank_accounts ?>&nbsp; <n style="float: left;"> <?php echo $fila->cantida_saldo ?><?php echo $fila->simbolo_divisa ?></n>
                              </p>
                            </option>
                          <?php
                          }
