        ...
        <div class="tab-pane active" id="tab1">
          ...
          <div class="col-md-12">
            <div class="portlet-body">
                  ...
                  <thead>
                    ...
                    <tr>
                      <form role="form" action="?admin=listac&guarda" method="post" enctype="multipart/form-data">
                        <center>
                          <th>
                            <center>Codigo Nuevo</center>
                          </th>
                          <th>
                            <center>Limite</center>
                          </th>
                        </center>
                    </tr>
                  </thead>
              ...
              <th>
                <center>Seleccionar Paquete</center>
              </th>
              <th>
                <center></center>
              </th>
                ...
                <tr>
                  ...
                  <td>
                    <select class="form-control" name="paquete">
                      ...
                      ?>
                        <option value="<?php echo  $id = $pagina->id_paquete; ?>">
                          <p><?php echo  $nomp = $pagina->nombre_p; ?></p>
                        </option>
