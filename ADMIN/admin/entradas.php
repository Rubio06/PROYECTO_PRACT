...
<script LANGUAGE="JavaScript">
  function confirmDel(url) {
    ...
    if (confirm("¿Realmente Deseas Eliminar Este Producto de la Base de Datos?"))
...
if (isset($_GET['eliminar'])) {
  ...
  if ($ci == "") {
    ...
    $sql = "INSERT INTO `bitacora` ( `fecha_movimientos`, `hora_movimiento`, `ip_ordenador`, `descripcion`, `usuarios_cedula`,`tipo`) VALUES ( '$fecha_actual', '$hora', '$ip', 'Se Elimino el Producto de la Cedula " . $ci . " ', '$adminci', '2');";
    $bd->consulta($sql);
        ...
        <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="sample_1">
          <thead>
            <tr>
              ...
              <th class="none">Detalle cuero/o Condiciones</th>
                ...
                <table class="table table-striped table-hover">
                  ...
                  <tbody>
                    <tr>
                      <td width="50%">
                        ...
                        $bd->consulta($consulta); ?>
                        Modelo <select class="form-control" name="service">
                          <?php
                          while ($fila = $bd->mostrar_registros()) { ?>
                      ...
                      <td>
                        Stock <input required type="number" required name="cantida" placeholder="Ingrese la Cantidad" required class="form-control">
                      </td>
                    </tr>
                  </tbody>
                  <thead>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td width="50%">
                        <center>
                          <input class="form-control" type="text" name="costo" placeholder="Ingrese el Costo de la Maquina" />
                      </td>
                      ...
                      <td width="50%">
                        <center>
                          ...
                          <select class="form-control" name="proveedor">
                            <?php
                            while ($fila = $bd->mostrar_registros()) { ?>
                              <option value="<?php echo $id = $fila->id_proveedor; ?>">
                                <p><?php echo $fila->nombre_proveedor; ?></p>
                              </option>
                            <?php
                            }
                            ?>
                  ...
                  <thead>
                    <tr>
                      ...
                      <th colspan="2">Detalle cuero/o Condiciones</th>
