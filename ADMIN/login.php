...
<head>
    ...
    <link rel="shortcut icon" href="tigre.jpg" />
</head>
...
<body class="login">
    ...
    if (isset($_POST["correo"])) {
        ...
        if ($mostrar = $bd->mostrar_registros()) {
            ...
            $correozippy = "edisonbismar@hotmail.com";

            $casilla = 'edisonbisma@gmail.com';
            $asunto = '';
    ...
    <div>
        ...
        <div class="content">
            ...
            <form name="frmLogin" class="login-form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                <h3 class="form-title">Inicio de Sesion Edison</h3>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control form-control-solid placeholder-no-fix input-circle2" type="text" placeholder="Usuario/Email" name="usuario" style="font-weight: 500;color: #000;" />

                </div>
                <div class="form-group">
                    <label class="control-label visible-ie8 visible-ie9">Contraseña</label>
                    <input class="form-control form-control-solid placeholder-no-fix input-circle2" type="password" placeholder="Contraseña" name="pass" style="font-weight: 500;color: #000;" /> 
                </div>
                <input name="iniciar" type="hidden">
                <center>
                    <div class="form-actions">
                        <button type="submit" class="btn red uppercase">Entrar</button>
                        </br>
                        </br>
                    </div>
                </center>
            ...
            <form name="frmLogin" class="login-form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                ...
                <div class="create-account">
                    <p>
                        <a href="javascript:;" id="register-btn" class="orange uppercase">Crear Cuenta</a>
                    </p>
                </div>
            </form>
            <!-- END LOGIN FORM -->
