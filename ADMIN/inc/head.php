...
if ($bd->numeroFilas() > 0) {
  ...
  $nameadmin = "SystemTaipe - Tecnology"; //Cambiamos el NOmbre de la empresa para todo el proceso
  $diradmin = "Av. Petit Thouars 1931 - Lince - Lima - Peru";
  $rifadmin = "v-23134135";
  $logoadmin = "../tigre.jpg";
  $celadmin = "940-120-981";
}
...
<head>
  ...
  <!-- AGREGAMOS EL ICONO DE LA EMPRESA -->
