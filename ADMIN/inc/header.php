<div class="page-header navbar navbar-fixed-top">
    <div class="page-header-inner ">
        <div class="page-logo">
            <a href="?mod=principal"><img src="./img/<?php echo  $logoadmin; ?>" alt="logo" class="logo-default" /> </a>
            <div class="menu-toggler sidebar-toggler" style="background: white;color: #fff;"> </div>
        </div>
                        ...
                        <ul class="dropdown-menu dropdown-menu-default">
                            <li>
                                <a href="?mod=view_cart">
                                    <i class="icon-basket"></i>Servicios en Fotocopiadoras y PC
